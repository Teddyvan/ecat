...
<script type='text/javascript'>
  ...
  $("#form").submit(function(e)
		{ // On s�lectionne le formulaire par son identifiant
			...
			//var donnees = $(this).serialize(); // On cr�er une variable contenantt le formulaire s�rialis�
		...
		{ // On sélectionner le formulaire par son identifiant
